...
procedure 'Discover',
	description: '''<html>Automatically create microservice models in CloudBees Flow for the services and the pods discovered within a namespace on a Kubernetes cluster.
<div>
    <ol>
