...
procedure 'Discover',
	description: '''<html>Automatically create microservice models in CloudBees CD for the services and the pods discovered within a namespace on a Kubernetes cluster.
<div>
    <ol>
        <li><b>Select your method of discovery from a Kubernetes Cluster</b>  There are two options for connecting to Kubernetes for discovery
            <ul>
                <li><b>Existing CloudBees CD Environment and Cluster</b>  Use the Cluster configuration details in an existing CloudBees CD environment to connect to Kubernetes. Enter details for the existing environment and cluster in the following parameters:
                    <ul>
                        ...
                        <li>Cluster Name: The name of the CloudBees CD cluster in the environment above that represents the Kubernetes cluster</li>
                    </ul></li>
