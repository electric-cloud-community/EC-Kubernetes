...
procedure 'Cleanup Cluster - Experimental',
	description: '[Experimental] This procedure is meant for testing purposes only and should not be used in a production environment. It will delete all services pods, deployments and replication controllers in a given Google Container Engine cluster.', {
